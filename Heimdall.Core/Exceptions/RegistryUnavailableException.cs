...
{
    public class RegistryUnavailableException : ApplicationException
    {
        /// <summary>
        /// Default constructor
        /// </summary>
        public RegistryUnavailableException()
            : base("The configured service registry in not responding.")
        {
        }
        ...
        /// </param>
        public RegistryUnavailableException(string message, System.Exception exception) :
        ...
        /// </param>
        protected RegistryUnavailableException(SerializationInfo info, StreamingContext context) :
            base(info, context)
        {
        }
    }
